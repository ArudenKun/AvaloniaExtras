...
/// </param>
[AutoInterface]
public class BoxLessQueue(IBoxLessValueHandler handler) : IBoxLessQueue
{
    ...
    private class TypedMessageQueue<T> : TypedValueQueue
        where T : struct
    {
    ...
    public void Enqueue<TValue>(TValue message)
        where TValue : struct
    {
